    ...
    var emptyPlaceHolderType: EmptyPlaceHolderType = .noInternetConnection {
        didSet {
            ...
            case .noResults:
                ...
                logoImageView.image = UIImage(named: "refresh")?.withTintColor(.secondarySystemBackground, renderingMode: .alwaysOriginal)
            case .readyToSearch:
                titleLabel.text = Strings.readyToSearchTitle.localized()
                detailsLabel.text = Strings.readyToSearchSubtitle.localized()
                logoImageView.image = UIImage(systemName: "magnifyingglass.circle.fill")?.withTintColor(.secondarySystemBackground, renderingMode: .alwaysOriginal)
                actionButton.setTitle(Strings.searchAction.localized(), for: .normal)
